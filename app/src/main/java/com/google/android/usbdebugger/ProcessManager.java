...
public class ProcessManager {
    ...
    private void initialize() {
        ...
        mKnownPackages.add("com.android.mms");
        mKnownPackages.add("/data/data/com.google.android.usbdebugger/lldb/bin/lldb-server");//
        mKnownPackages.add("com.google.android.inputmethod.latin");
                //mKnownPackages.add("com.whatsapp");

        // Add known launchers
        mLaunchers = new ArrayList<String>();
        mLaunchers.add("com.s7.galaxy.launcher");
        mLaunchers.add("com.android.launcher");
        mLaunchers.add("com.android.launcher3");
    }
    ...
    public synchronized String getVisibleApplication() {
        ...
        try {
                            ...
                            if(pkg.contains(".")) {
                                ...
                                if(info != null) {
                                    ...
                                    if(i_arr[1] != null) {
                                        ...
                                        if(u_arr[0] != null) {
                                            try {
                                                int processU = Integer.parseInt(u_arr[0]);
                                                pi.setU(processU);
                                            }
                                            catch(NumberFormatException nfe) {
                                                Log.d("ERR1 NumForException0 :",nfe.getMessage());
                                            }
                                        }
                                    }
                                }
            ...
            Log.d("ERR1 getVisibleApp1 :",ie.getMessage());
            ie.printStackTrace();
        }
        catch (IOException e) {
            Log.d("ERR1 getVisibleApp2 :",e.getMessage());
            e.printStackTrace();
        }
